...
| `composite_gate.py` | The composite screenshot regression as a gate: runs `midi-sink --dev --composite-dump`, compares the print of the canonical field script bitwise against `tests/fixtures/composite_512_metal.rgba`, and proves red on a corrupted copy (Phase 6 step 41, DECISIONS_5 #45). | Step 41 |
