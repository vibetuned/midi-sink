...
| `make_demo_instrument.py` | Writes the demo instrument's placeholder into `voxo/demo/` (Phase 7 step 52): a synthesised music box, three zones, public domain by construction — the slot's filler until the author records the real one (DECISIONS_6 #21). | Step 52 |
