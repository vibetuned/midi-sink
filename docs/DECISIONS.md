...
Implementation decisions and resolved ambiguities, in two parts:
**Part I** covers the v1 build-out (spec v1, roadmap steps 1–7);
**Part II** covers spec v2 (steps 8–14). Entry numbering restarts in
Part II — references of the form `DECISIONS.md #n` (code comments,
evidence, git history) mean Part I, and `DECISIONS_2 #n` /
`DECISIONS_2.md #n` mean Part II (the file they referred to was
