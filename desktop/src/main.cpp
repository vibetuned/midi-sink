...
int main(int argc, char** argv) {
    ...
    // Window/taskbar icon. Only X11 and Win32 implement it — Wayland takes the
    // icon from a .desktop file and macOS from the app bundle, and GLFW reports
    // an error there, so ask the platform first rather than log noise.
